...
public class ActivityTvScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Exit = findViewById(R.id.exo_dil);
        dil = findViewById(R.id.dil_exo);
        ...
        if (Config.ENABLE_GRID_MODE_2) {
            recyclerView.setLayoutManager(new LinearLayoutManager(ActivityTvScreen.this, RecyclerView.VERTICAL,false));
        }else {
            recyclerView.setLayoutManager(new GridLayoutManager(ActivityTvScreen.this, Config.GRID_SPAN_COUNT));
            recyclerView.addItemDecoration(new SpacesItemDecoration(Config.GRID_SPAN_COUNT, Constant.SPACE_ITEM_DECORATION, true));
        }


        //set data and list adapter
        adapterChannel = new AdapterChannel_exo(ActivityTvScreen.this, recyclerView, new ArrayList<Channel>());
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (recyclerView.getChildCount() > 0 && ActivityTvScreen.this.thistime){
                    ActivityTvScreen.this.thistime = false;
        ...
        adapterChannel.setOnItemClickListener(new AdapterChannel_exo.OnItemClickListener() {
            ...
            public void onItemClick(View v, Channel obj, int position) {
                player.stop();
                finish();
                Intent intent = new Intent(ActivityTvScreen.this, ActivityTvScreen.class);
        ...
        Picasso.with(ActivityTvScreen.this)
        ...
        RenderersFactory renderersFactory = new DefaultRenderersFactory(ActivityTvScreen.this);
    ...
    public boolean dispatchKeyEvent(KeyEvent event){
        ...
        if (event.getAction()== KeyEvent.KEYCODE_BACKSLASH){
            onBackPressed();
        }
        if (event.getAction()==KeyEvent.KEYCODE_HOME){
            ...
            finish();
            Intent intent;
            intent = new Intent(ActivityTvScreen.this, MainActivity.class);
            startActivity(intent);
        }
        if (event.getAction()==KeyEvent.KEYCODE_ESCAPE){
            player.stop();
            finish();
        }
        ...
        if (event.getAction()==KeyEvent.KEYCODE_BUTTON_SELECT){
            kanalet.setVisibility(View.VISIBLE);
            dil.setVisibility(View.VISIBLE);
            ...
            b_list_exo.setSelected(true);
            dil.setVisibility(View.VISIBLE);
        } if (event.getAction()==KeyEvent.KEYCODE_DPAD_UP_RIGHT) {
            dil.setVisibility(View.VISIBLE);
        }
